...
<head>
    ...
    <style>
        a{color: #222; text-decoration: none;} /*링크 초기화*/
        a:hover{ font-weight: bold; color:rgb(102, 28, 241);}
...
<body>
    ...
    <header id="main_header">
        ...
        <div><select id="locale_switch" name="언어선택">
            ...
            <div id="main_table">
                <ul>
                    ...
                    <li id="main_menu05"><span><h2>방문.이용</h2></span>
                        ...
                        <li><a href="#">디지털도서관</a></li>
                        <li><a href="#">기록매체박물관</a></li>
                        <li><a href="#">편의시설</a></li>
    ...
    <div id="content">
        <section id="main_section">
            <article class="main_article">
                ...
                <% if(userId==null){%>
                    <div id="onoff" style="display: block">
                        <legend>로그인</legend>
                        <form name="frm2" method=post action=LoginTest.jsp>
                        <input type="text" placeholder="아이디" name="userId">
                        <input type="password" placeholder="비밀번호" name="userPassword">
                        <input class="sublog" type="submit" value="로그인">
                        </form>
                    ...
                    <% }else { %>
                        ...
                        <h1 id="lout"><%=userId %>님 환영합니다.</h1>
                        <input id="myInfo" type="button" value="내정보보기" onclick="Info();">
                        <input id="logOutBnt" type="button" value="로그아웃" onclick="location.href='LogoutTest.jsp';">
                      <% 
                      	} 
                      %>
                    </div>
            ...
            <div id="newBook">
                <div id="newBook_1">
                    <div>
                        <ul class="best_book"><h2>베스트셀러</h2>
            ...
            <aside class="main_aside">
                    <div>
                        <a href="../Project/home.html">홈으로가기</a>
                    </div>
                </aside>
        </section>
    </div>
